...
HUNTER_SOURCES = [
    ...
    {
        "id": "vedomosti_companies",
        "name": "Ведомости — Компании",
        "base_url": "https://www.vedomosti.ru/companies",
        "coverage": "Россия",
        "source_type": "business_media_company_directory",
        "use_for": [
            "карточка компании",
            "новостной фон",
            "события и сделки",
            "отраслевой контекст",
            "масштаб и публичная значимость",
        ],
        "access_mode": "search_discovery_and_context_only",
        "priority": 80,
        "notes": "Полезен прежде всего для контекстной квалификации средних и крупных компаний. Не использовать как единственный источник юридических или финансовых фактов; учитывать возможный платный доступ к части материалов.",
    },
    {
        "id": "rusprofile",
        "name": "Rusprofile",
...
def get_hunter_sources() -> dict:
    return {
        ...
        "rules": [
            ...
            "медиаисточники использовать для оценки контекста, событий и публичной значимости, но не как единственный источник фактов",
        ],
    }
