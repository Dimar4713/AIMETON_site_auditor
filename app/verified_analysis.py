...
async def run_verified_enriched_site_analysis(
    ...
    DaData is used only as a non-authoritative registry mirror between first-party
    identity extraction and external discovery.
    """
    ...
    # DaData records are registry-mirror facts, not document quotes. Keep them in
    # CompanyFact with explicit trust notes rather than fabricating EvidenceSource.
    existing_fact_keys = {
